...
# Load the tokenizer and model fine-tuned for coreference resolution with gender bias
tokenizer = AutoTokenizer.from_pretrained("uclanlp/corefBias")
model = AutoModelForSequenceClassification.from_pretrained("uclanlp/corefBias")
